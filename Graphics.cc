...
void Graphics :: myglutInit( int argc, char** argv )
{
	...
	glutInitWindowSize(windowMaxX, windowMaxY); 		                // set pixel window
	glutInitWindowPosition(windowPosX, windowPosY); 		// place window top left on display
...
void Graphics :: myInit(void)
{
	...
	glLoadIdentity();
	gluOrtho2D(0.0, windowMaxX, 0.0, windowMaxY);
